...
public class PhantomIdentityStmt implements Stmt {

    private final SootMethod method;

    public static PhantomIdentityStmt getInstance(SootMethod method) {
        return new PhantomIdentityStmt(method);
    }

    private PhantomIdentityStmt(SootMethod method) {
        this.method = method;
    }
    ...
    public boolean equals(Object o) {
        ...
        PhantomIdentityStmt that = (PhantomIdentityStmt) o;
